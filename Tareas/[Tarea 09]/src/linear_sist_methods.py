...
def eliminacion_gaussiana3(A: np.ndarray) -> np.ndarray:
    A = np.array(A)
...
def eliminacion_gauss_jordan(A: np.ndarray) -> np.ndarray:
    """
    Aplica el método de Gauss-Jordan para resolver un sistema de ecuaciones lineales.
    
    Args:
        A (np.ndarray): Matriz aumentada del sistema de ecuaciones.
    
    Returns:
        np.ndarray: Vector de soluciones del sistema.
    """
